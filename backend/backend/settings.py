...
SECRET_KEY = (
    "django-insecure-sb42%cdcu$3^22*+owj4d@x6_ohg1o)ljbk3vfnb_aha#p)1s@"
)
...
MIDDLEWARE = [
    ...
    "Student.middleware.CsrfExemptMiddleware",
...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": f"{datetime.datetime.now().strftime('%y__%m__%d')}.log",
            "formatter": "verbose",
        },
    },
    "loggers": {
